define([
    ...
    $.widget('mage.Magneto_AdminResetPassword__changepassword', $.mage.modal, {
        options: {
            title: $.mage.__('Please enter new password'),
            modalClass: 'magneto-adminresetpassword-modal',
    ...
    return function (data, el) {
        if (!changePasswordModal) {
            changePasswordModal = $.mage.Magneto_AdminResetPassword__changepassword(data);
        }
        $(el).click(function () {
